...
const ruleSchema = z.object({
  accountId: z.string(),
  name: z.string().min(1),
  type: z.enum(["maxContracts", "stopRange", "dailyLossLimit", "breakeven", "custom", "maxTradesPerDay", "maxTradesPerSession", "breakevenAtR", "scaleOut", "maxDailyProfit", "losingDayBreak", "lossStreakThrottle"]),
